...
print "Max:", max([data_dict[n][feature_1] for n in data_dict if data_dict[n][feature_1] != 'NaN'])
print "Min:", min([data_dict[n][feature_1] for n in data_dict if data_dict[n][feature_1] != 'NaN'])
